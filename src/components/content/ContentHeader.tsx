...
import type { ContentView } from "@/hooks/useContentHub";
...
export default function ContentHeader({ brands, activeBrand, onBrandChange, view, onViewChange }: Props) {
  return (
    <div className="border-b border-gray-800 px-4 py-2.5 flex items-center gap-3 shrink-0">
      <h1 className="text-base font-bold shrink-0"><span className="text-blue-400">Content</span></h1>

      {/* Brand tabs — scrollable */}
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <Link href="/content/create" title="Create post" className="p-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors">
          <Plus size={16} />
        </Link>
      </div>
    </div>
