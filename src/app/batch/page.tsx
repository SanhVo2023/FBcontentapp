  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-gray-800 px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="text-lg font-bold"><span className="text-blue-400">Batch</span> Mode</h1>
        ...
        <div className="ml-auto flex gap-2">
          ...
          <Link href="/templates" className="px-3 py-1.5 bg-gray-800 text-gray-300 text-xs rounded hover:bg-gray-700">AI Templates</Link>
