  ...
  return (
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="border-b border-gray-800 px-5 py-3 flex items-center gap-3">
        <h1 className="text-base font-bold"><span className="text-blue-400">Apolo</span> Content Studio</h1>
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
        {/* Content */}
        <div>
          <h2 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-3">Content</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <Link href="/content" className="bg-gradient-to-br from-blue-600/20 to-blue-600/5 border border-blue-500/30 rounded-xl p-4 hover:border-blue-500/60 transition group">
              ...
              <div className="font-semibold text-sm text-white group-hover:text-blue-400 transition">Content Hub</div>
              <div className="text-[11px] text-gray-500 mt-1">Kanban board, calendar & filters</div>
            </Link>
            ...
            <Link href="/content" className="bg-gradient-to-br from-teal-600/20 to-teal-600/5 border border-teal-500/30 rounded-xl p-4 hover:border-teal-500/60 transition group">
              <div className="text-xl mb-1.5">📅</div>
              <div className="font-semibold text-sm text-white group-hover:text-teal-400 transition">Calendar</div>
              <div className="text-[11px] text-gray-500 mt-1">Visual content scheduling</div>
            </Link>
          </div>
        </div>
        ...
        {/* Image Studio */}
        <div>
          <h2 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-3">Image Studio</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <Link href="/studio" className="bg-gradient-to-br from-amber-600/20 to-amber-600/5 border border-amber-500/30 rounded-xl p-4 hover:border-amber-500/60 transition group">
              <div className="text-xl mb-1.5">🎨</div>
              <div className="font-semibold text-sm text-white group-hover:text-amber-400 transition">Generate Banner</div>
              <div className="text-[11px] text-gray-500 mt-1">Single Facebook banner</div>
            </Link>
        ...
        {/* Brands */}
        <div>
          <h2 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-3">Brands ({brands.length})</h2>
          {loading ? (
